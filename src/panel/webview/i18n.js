...
(function () {
	...
	const defaultStrings = {
		...
		toolSubgroupInfra: 'Infrastructure / IT',
	...
	const localizations = {
		ru: {
			...
			toolSquare: 'Прямоугольник',
			toolRoundedRectangle: 'Прямоугольник со скруглениями',
			toolCircle: 'Эллипс',
			...
			toolSubgroupInfra: 'Инфраструктура / IT',
