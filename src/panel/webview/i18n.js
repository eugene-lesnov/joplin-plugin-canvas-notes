...
(function () {
	...
	const defaultStrings = {
		...
		toolStar: 'Star',
		toolHeart: 'Heart',
		toolSpeechBubble: 'Speech bubble / Callout',
		toolStickyNote: 'Note / Sticky note',
		toolMessageEnvelope: 'Message / Envelope',
		// Flowchart
		...
		toolAlternateProcess: 'Alternate process',
		// Architecture
		...
		// Containers / data
		toolSwimlane: 'Swimlane',
		toolTable: 'Table',
		toolStoredData: 'Stored data',
		toolTape: 'Tape',
		// Lines
		toolLine: 'Solid line',
		toolArrow: 'Arrow',
		...
		toolSubgroupBasic: 'Basic / General',
		toolSubgroupFlowchart: 'Flowchart',
		toolSubgroupContainers: 'Containers',
		toolSubgroupDataDocuments: 'Data / Documents',
	...
	const localizations = {
		ru: {
			...
			toolStar: 'Звезда',
			toolHeart: 'Сердце',
			toolSpeechBubble: 'Речевая выноска',
			toolStickyNote: 'Заметка / стикер',
			toolMessageEnvelope: 'Сообщение / конверт',
			// Flowchart
			...
			toolAlternateProcess: 'Альтернативный процесс',
			// Architecture
			...
			// Containers / data
			toolSwimlane: 'Дорожка',
			toolTable: 'Таблица',
			toolStoredData: 'Хранимые данные',
			toolTape: 'Лента',
			// Lines
			...
			toolSubgroupBasic: 'Базовые / общие',
			toolSubgroupFlowchart: 'Блок-схемы',
			toolSubgroupContainers: 'Контейнеры',
			toolSubgroupDataDocuments: 'Данные / документы',
